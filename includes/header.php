    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/HMW-logo-carb2.png" alt="image"/></a> </div>
        </div>
   ...
   <i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="machinery-listing.php">Heavy equipment Listing</a>
          <li><a href="page.php?type=aboutus"> Accessories</a></li>
